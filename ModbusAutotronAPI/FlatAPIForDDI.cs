...
//    Copyright QuadTech 1998/2018 All Rights Reserved
//
...
{
    public static class FlatAPIForDDI
    {
        /// <summary>
        ...
        public static int EntryPoint(string ignored)
        {
            ...
            var dataArrayHandle = GCHandle.Alloc(DataArray, GCHandleType.Pinned);
            pByteArray = dataArrayHandle.AddrOfPinnedObject();
        ...
        static byte[] dataArray = new byte[8] { 32, 16, 32, 16, 32, 16, 32, 16 };
        ...
        public static byte[] DataArray
        {
            ...
            set
            {
                Array.Copy(value, dataArray, dataArray.Length);
            }
        }
    }
