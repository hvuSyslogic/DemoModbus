...
// Type: PhoenixContact.PxC_Library.Util.UpdateProgressBar
...
{
  public delegate bool UpdateProgressBar(string ProgressText, int TotalPercentage, int ProgressPercentage);
}
