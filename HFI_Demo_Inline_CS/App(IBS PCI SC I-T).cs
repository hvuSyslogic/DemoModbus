...
namespace HFI_Demo_Inline_CS
{
    ...
    /// </summary>
    public sealed class App_IBS_PCI_SC_IT : IDisposable
    {
        // Error logging
        ...
        public Controller_IBS_G4 Controller;

        // Create the variables for the input data
        // First input terminal DI 16
        public VarInput InBit_0 = new VarInput(0, PD_Length.Word, 1, 0);

        public VarInput InBit_1 = new VarInput(0, PD_Length.Word, 1, 1);
        public VarInput InVariable = new VarInput(0, PD_Length.Word, 12, 4);

        // Second input terminal DI 32
        public VarInput InByteArray = new VarInput(2, 4);

        // PCP terminal inputs (RS232 terminal)
        public VarInput InRS232_1 = new VarInput(6, PD_Length.Word, 16, 0);

        // Create the variables for the output data
        // First output terminal DO 16
        public VarOutput OutBit_0 = new VarOutput(0, PD_Length.Word, 1, 0);

        public VarOutput OutBit_1 = new VarOutput(0, PD_Length.Word, 1, 1);
        public VarOutput OutVariable = new VarOutput(0, PD_Length.Word, 12, 4);

        // Second output terminal DO 32
        public VarOutput OutByteArray = new VarOutput(2, 4);

        // PCP terminal outputs (RS232 terminal)
        public VarOutput OutRS232_1 = new VarOutput(6, PD_Length.Word, 16, 0);
        ...
        /// Constructor
        /// </summary>
        public App_IBS_PCI_SC_IT()
        {
            this.ExceptionList = new Queue<Exception>();
            // Create the controller with a name
            this.Controller = new Controller_IBS_G4("IBS PCI SC I-T");

            // Settings of the controller
            this.Controller.Description = "IBS PCI SC I-T for Demonstaration";
            this.Controller.Connection = "1";

            this.Controller.Startup = ControllerStartup.PhysicalConfiguration;

            this.Controller.UpdateProcessDataCycleTime = 5;
            ...
            //Controller.Configuration.EnableIBS_Sync         = false;
        ...
        private void Controller_OnUpdateMailbox(object sender)
        {
            ...
            {
                if (this.PcpRS232_1.Ready || this.PcpRS232_1.Error) this.PcpRS232_1.Disable();
            }
        ...
        #endregion *** Get the PCP-Data from the Application *********************************
