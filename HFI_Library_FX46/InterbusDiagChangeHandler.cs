...
// Type: PhoenixContact.HFI.Inline.InterbusDiagChangeHandler
...
{
  public delegate void InterbusDiagChangeHandler(object Sender, StatusRegister StatusReg, int ParameterReg, int ExtendedParaReg);
}
